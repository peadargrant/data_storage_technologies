...
Example: Internal transfer time Determine the transfer time given an internal transfer rate of 40MB/s and a block size of 32kB.
...
\autoimage{ncq_diagram}{Native Command Queueing}{native-command-queueing}

A hard disk receives multiple commands in quick succession.
Each command will be delayed by seek time and rotational latency.
