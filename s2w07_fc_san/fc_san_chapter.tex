...
\subsection{Comparison to IP SAN}\label{comparison-to-ip-san}
...
\section{Fabric types}\label{fabric-types}

\subsection{Point-to-Point}\label{point-to-point}
...
\begin{figure}
\centering
%\includegraphics{fc_point_to_point}
\caption{Point-To-Point (Wikipedia, adapted){}}
\end{figure}
...
\subsection{Switched fabric}\label{switched-fabric}

Most SAN implementations involve a switched fabric, .

\begin{figure}
\centering
%\includegraphics{fc_switched_fabric}
\caption{FC switched fabric (Wikipedia, adapted){}}
\end{figure}
...
\begin{figure}
\centering
%\includegraphics{fc_layers}
\caption{Fibre Channel Layers
...
\subsection{FC address}\label{fc-address}

FC addresses are 24-bit dynamically assigned addresses, .

\begin{figure}
\centering
%\includegraphics{fc_address}
\caption{FC address (EMC ISM book){}}
\end{figure}
...
\begin{figure}
\centering
%\includegraphics{fc_wwn}
\caption{FC world wide name (WWN) (EMC ISM book){}}
\end{figure}
...
\section{Fabric services}\label{fabric-services}
...
\begin{figure}
\centering
%\includegraphics{fc_fabric_services}
\caption{FC fabric services (EMC ISM book){}}
\end{figure}
...
\subsection{Login types}\label{login-types}
...
\begin{figure}
\centering
%\includegraphics{fc_zoning}
\caption{FC zoning (EMC ISM book){}}
\end{figure}
...
\subsection{Zone types}\label{zone-types}
...
\begin{figure}
\centering
%\includegraphics{fc_zone_types}
\caption{FC Zone types (EMC ISM book){}}
\end{figure}

\section{Topologies}\label{topologies}

\subsection{Single-switch}\label{single-switch}
...
\subsection{Mesh fabric}\label{mesh-fabric}
...
\begin{figure}
\centering
%\includegraphics{fc_mesh_topologies}
\caption{Mesh topologies (EMC ISM book){}}
\end{figure}
...
\subsection{Core-Edge Fabric}\label{core-edge-fabric}
...
\begin{figure}
\centering
%\includegraphics{fc_single_core_topology}
\caption{Single-core topology (EMC ISM book){}}
\end{figure}

\section{Need for integration}\label{need-for-integration}
...
\section{Fibre Channel over Ethernet
(FCoE)}\label{fibre-channel-over-ethernet-fcoe}
...
\subsection{FCoE frame format}\label{fcoe-frame-format}
...
\begin{figure}
\centering
%\includegraphics{fcoe_frame}
\caption{FCoE frame (Wikipedia){}}
\end{figure}

\subsection{FCoE fabric}\label{fcoe-fabric}
...
\subsection{FCoE-FC gateway}\label{fcoe-fc-gateway}
...
\begin{figure}
\centering
%\includegraphics{fcoe_gateway}
\caption{FCoE gateway{}}
\end{figure}
...
\subsection{FCoE host hardware}\label{fcoe-host-hardware}
...
\begin{figure}
\centering
%\includegraphics{fcoe_cna}
\caption{FCoE converged networking (Wikipedia){}}
\end{figure}

It is generally recommended that VLANs are used to separate FCoE and IP
traffic where they co-exist.

\subsection{Application Areas}\label{application-areas}
...
\section{Fibre Channel over IP (FCIP)}\label{fibre-channel-over-ip-fcip}
...
\begin{figure}
\centering
%\includegraphics{fcip_network}
\caption{FC san extended using FCIP (TechTarget){}}
\end{figure}
...
\subsection{Application areas}\label{application-areas-1}
...
\section{FC-iSCSI integration}\label{fc-iscsi-integration}
...
\begin{figure}
\centering
%\includegraphics{fc_iscsi_bridge}
\caption{iSCSI hosts accessing FC storage via gateway (Cisco){}}
\end{figure}

\subsection{Application areas}\label{application-areas-2}
