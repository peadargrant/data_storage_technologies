...
\subsection{SAN types}\label{san-types}
...
\subsection{Usage points}\label{usage-points}
...
\subsection{Non-shared storage}\label{non-shared-storage}
...
\subsection{SAN vs NAS}\label{san-vs-nas}
...
\begin{figure}
\centering
%\includegraphics{iscsi_initiator_target}
\caption{iSCSI initiator and target{}}
\end{figure}

\subsection{Initiator}\label{initiator}
...
\begin{figure}
\centering
%\includegraphics{iscsi_offload}
\caption{iSCSI offloading{}}
\end{figure}
...
\begin{figure}
\centering
%\includegraphics{iscsi_stack}
\caption{iSCSI stack{}}
\end{figure}

\subsection{Protocol data units (PDUs)}\label{protocol-data-units-pdus}
...
\begin{figure}
\centering
%\includegraphics{iscsi_encapsulation}
\caption{iSCSI encapsulation (EMC){}}
\end{figure}
...
\subsection{Target hardware}\label{target-hardware}
...
\subsection{Target naming (IQNs)}\label{target-naming-iqns}
...
\subsection{Username / passwords}\label{username-passwords}
...
\subsection{LUN masking}\label{lun-masking}
...
\section{iSCSI initiator operations}\label{iscsi-initiator-operations}
...
\subsection{Linux software initiator}\label{linux-software-initiator}
