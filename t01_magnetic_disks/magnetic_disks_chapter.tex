...
\autoimage{hard_drive_components_3d}{Hard drive components}{hard-drive-components}
...
\autoimage{disk_geometry}{Disk Geometry}{disk-geometry}
...
\section{Logical block addressing}
...
\autoimage{zoned_bit_recording.png}{Zoned bit recording}{zoned-bit-recording}
